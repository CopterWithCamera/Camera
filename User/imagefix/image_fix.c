...
{
	static float last_length,last_angle,To_next_length,To_next_angle;
	
	test_simple(gray_column_array,last_length,last_angle,&length,&angle,&To_next_length,&To_next_angle);
